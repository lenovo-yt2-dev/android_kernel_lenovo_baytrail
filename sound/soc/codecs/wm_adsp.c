...
#define WM_ADSP_FW_EZ2CONTROL_ZH_CN	5	/* traditional Chinese */
#define WM_ADSP_FW_EZ2CONTROL_JA	6	/* Japanese */
...
#define WM_ADSP_FW_TAIDA_KAP 14
#define WM_ADSP_FW_HIFI_FILTERS 15
#define WM_ADSP_FW_TX_HEADPHONE   16
#define WM_ADSP_FW_TX_WB          17
#define WM_ADSP_FW_TX_SPEAKER_WB  18
#define WM_ADSP_FW_TX_HEADPHONE_WB 19
#define WM_ADSP_FW_TRACE          20
#define WM_ADSP_FW_EDAC           21
...
static const char *wm_adsp_fw_text[WM_ADSP_NUM_FW] = {
	...
	[WM_ADSP_FW_EZ2CONTROL_ZH_CN] = "Ez2Control ZH_CN",
	[WM_ADSP_FW_EZ2CONTROL_JA] = "Ez2Control JA",
	[WM_ADSP_FW_EZ2LISTEN_SP] = "Ez2Listen SP",
	[WM_ADSP_FW_EZ2LISTEN_HP] = "Ez2Listen HP",
	[WM_ADSP_FW_EZ2HEAR_SP_TX] = "Ez2HearSP Tx",
	[WM_ADSP_FW_EZ2HEAR_HS_TX] = "Ez2HearHS Tx", // 10
	[WM_ADSP_FW_EZ2HEAR_RX] = "Ez2Hear Rx",
	[WM_ADSP_FW_EZ2FACETALK_TX] = "Ez2FaceTalk Tx",
	[WM_ADSP_FW_EZ2FACETALK_RX] = "Ez2FaceTalk Rx",
	[WM_ADSP_FW_TAIDA_KAP] =         "Taida Kap",
	[WM_ADSP_FW_HIFI_FILTERS] =      "HiFi Filters",
	[WM_ADSP_FW_TX_HEADPHONE] =      "Tx Headphone",
	[WM_ADSP_FW_TX_WB] =      "Tx WB",
	[WM_ADSP_FW_TX_SPEAKER_WB] =  "Tx Speaker WB",
	[WM_ADSP_FW_TX_HEADPHONE_WB] = "Tx Headphone WB",
...
/* WB firmware is same with NB, only coeff file has difference */
static struct wm_adsp_fw_defs wm_adsp_fw[WM_ADSP_NUM_FW] = {
	...
	[WM_ADSP_FW_EZ2CONTROL_ZH_CN] = {
		.file = "ez2-control_zh_cn",
		.compr_direction = SND_COMPRESS_CAPTURE,
		.num_caps = ARRAY_SIZE(ez2control_caps),
		.caps = ez2control_caps,
	},
	[WM_ADSP_FW_EZ2CONTROL_JA] = {
		.file = "ez2-control_ja",
		.compr_direction = SND_COMPRESS_CAPTURE,
		.num_caps = ARRAY_SIZE(ez2control_caps),
		.caps = ez2control_caps,
	...
	[WM_ADSP_FW_TAIDA_KAP] =         { .file = "taida-kap"},
	[WM_ADSP_FW_HIFI_FILTERS] =        { .file = "hifi-filters"},
	[WM_ADSP_FW_TX_HEADPHONE] =     { .file = "tx-headphone" },
	[WM_ADSP_FW_TX_WB] =     { .file = "tx", .binfile="tx-wb" },
	[WM_ADSP_FW_TX_SPEAKER_WB] =     { .file = "tx-spk", .binfile="tx-spk-wb" },
	[WM_ADSP_FW_TX_HEADPHONE_WB] =   { .file = "tx-headphone", .binfile="tx-headphone-wb" },
	[WM_ADSP_FW_TRACE] = {
		.file = "trace",
		.compr_direction = SND_COMPRESS_CAPTURE,
			  ...
			  struct snd_ctl_elem_value *ucontrol)
{
    ...
    adsp_info(adsp, "%s: Firmware[%d]: %d\n", __func__, e->shift_l, ucontrol->value.integer.value[0]);
	return 0;
}
...
int wm_adsp2_init(struct wm_adsp *adsp, bool dvfs)
{
	...
	if (dvfs) {
        if (arizona && arizona->dcvdd)
            adsp->dvfs = arizona->dcvdd;
        else {
            adsp->dvfs = regulator_get(adsp->dev, "DCVDD");
            if (IS_ERR(adsp->dvfs)) {
...
err_dcvdd:
//	regulator_put(adsp->dvfs);
	return ret;
}
EXPORT_SYMBOL_GPL(wm_adsp2_init);

void wm_adsp2_exit(struct wm_adsp *adsp)
{
    printk("arizona %s\n", __func__);
/*	if (adsp->dvfs)
        regulator_put(adsp->dvfs);
...
EXPORT_SYMBOL_GPL(wm_adsp2_exit);
