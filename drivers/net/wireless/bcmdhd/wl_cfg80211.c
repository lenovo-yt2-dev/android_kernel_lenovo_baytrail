...
#define LENOVO_FIRST_SCAN_SHORT_TIME
#ifdef LENOVO_FIRST_SCAN_SHORT_TIME
int g_LenovoFirstScan=0;
#endif
...
#ifdef LENOVO_FIRST_SCAN_SHORT_TIME
	if(g_LenovoFirstScan==0) {
		params->active_time = 20;
		printk("zhl %s: n_ssids=%d,n_channels=%d\n",__func__,n_ssids,n_channels);
	}
#endif
