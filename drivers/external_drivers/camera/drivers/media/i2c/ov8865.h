...
#define BU64243_DEFAULT_SLEW_RATE			0x03	/* fatest */
...
#define OV8865_MWB_GAIN_MAX			0x0fff
...
static const struct ov8865_reg ov8865_BasicSettings[] = {
	...
	/* otp key setting */
	{OV8865_8BIT, {0x3820}, 0x00},	/* Mirror off, flip on */
	{OV8865_8BIT, {0x3821}, 0x46},	/* Align with Intel/Lenovo requirement */
...
static const struct ov8865_reg ov8865_3280x1852_30fps[] = {
	...
	{OV8865_8BIT, {0x380d}, 0x00},
	{OV8865_8BIT, {0x380e}, 0x07},
	{OV8865_8BIT, {0x380f}, 0x52},
	{OV8865_8BIT, {0x3813}, 0x02},
	{OV8865_8BIT, {0x3814}, 0x01},
	{OV8865_8BIT, {0x3821}, 0x46},
	{OV8865_8BIT, {0x382a}, 0x01},
...
static struct ov8865_resolution ov8865_res_preview[] = {
	...
	},
	{
		 ...
		 .fps_options =  {
			{
				.fps = 30,
				.pixels_per_line = 0x0a00, /* 2560 */
				.lines_per_frame = 0x0752, /* 1874 */
			},
			{
			}
		}
