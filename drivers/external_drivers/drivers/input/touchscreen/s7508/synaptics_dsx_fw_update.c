...
#define BLADE2_8_O_GF "blade2_8_o_gff.img"		//blade2 8inch ofilm GFF
#define BLADE2_8_G_GF "blade2_8_g_gff.img"		//blade2 8inch GIS GFF
#define BLADE2_10_O_GF "blade2_10_o_gff.img"		//blade2 10inch ofilm GFF
#define BLADE2_10_O_GM "blade2_10_o_gmf.img"		//blade2 10inch ofilm metalmesh
#define BLADE2_10_G_GF "blade2_10_g_gff.img"		//blade2 10inch GIS GFF
#define BLADE2_10_G_GM "blade2_10_g_gmf.img"		//blade2 10inch GIS GFF

#define DO_STARTUP_FW_UPDATE

#define STARTUP_FW_UPDATE_DELAY_MS 100 /* ms */
...
*/
	if (fwu->ext_data_source) {
		...
		if((strcmp(fwu->product_id, "Blade8_G2") == 0) && (fwu->productinfo1 == 1)){
			strncpy(fwu->image_name, BLADE2_8_O_GF, MAX_IMAGE_NAME_LEN);
			blade10 = 0;
		}
		else if((strcmp(fwu->product_id, "Blade8_G2") == 0) && (fwu->productinfo1 == 6)){
			strncpy(fwu->image_name, BLADE2_8_G_GF, MAX_IMAGE_NAME_LEN);
			blade10 = 0;
		}
		else if(((strcmp(fwu->product_id, "Blade10_G2") == 0) || (strcmp(fwu->product_id, "X10_2_GFF") == 0)) && (fwu->productinfo1 == 1)){
			strncpy(fwu->image_name, BLADE2_10_O_GF, MAX_IMAGE_NAME_LEN);
		}
		else if((strcmp(fwu->product_id, "X10_2_GMF") == 0) && (fwu->productinfo1 == 1)){
			strncpy(fwu->image_name, BLADE2_10_O_GM, MAX_IMAGE_NAME_LEN);
		}
		else if((strcmp(fwu->product_id, "Blade10_G2") == 0) && (fwu->productinfo1 == 6)){
			strncpy(fwu->image_name, BLADE2_10_G_GF, MAX_IMAGE_NAME_LEN);
		}
		else if((strcmp(fwu->product_id, "X10_2_GMF") == 0) && (fwu->productinfo1 == 6)){
			strncpy(fwu->image_name, BLADE2_10_G_GM, MAX_IMAGE_NAME_LEN);
		}
		else{
			printk("unknown touch product id %s.\n", fwu->product_id);
			goto exit;
		}
		dev_dbg(rmi4_data->pdev->dev.parent,
				"%s: Requesting firmware image %s\n",
