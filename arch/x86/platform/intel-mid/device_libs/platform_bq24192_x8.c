...
#include <linux/i2c.h>
#include <linux/sfi.h>
#include <linux/power/bq24192_charger_x8.h>
...
#define BYTCR_CHRG_CUR_MEDIUM		1800
#define BYTCR_CHRG_CUR_LOW		1200
...
static void *platform_byt_get_batt_charge_profile(void)
{
	...
	temp_mon_range[0].full_chrg_vol = 4352;
	temp_mon_range[0].full_chrg_cur = 1200;
	temp_mon_range[0].maint_chrg_vol_ll = 4300;
	temp_mon_range[0].maint_chrg_vol_ul = 4352;
	temp_mon_range[0].maint_chrg_cur =1200;
